...
|     | sequential | parallel |
| --- | ---------- | -------- |
| normalized (unbatched) | ![](https://github.com/Mateenmok/twitter_postgres_parallel/workflows/tests_normalized_sequential/badge.svg) | ![](https://github.com/Mateenmok/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg) |
| normalized (batched) | ![](https://github.com/Mateenmok/twitter_postgres_parallel/workflows/tests_normalizedbatch_sequential/badge.svg) |  ![](https://github.com/Mateenmok/twitter_postgres_parallel/workflows/tests_normalizedbatch_parallel/badge.svg) |
| denormalized | ![](https://github.com/Mateenmok/twitter_postgres_parallel/workflows/tests_denormalized_sequential/badge.svg) | ![](https://github.com/Mateenmok/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg) |
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        | 17m13.907s                | 5m7.063s                  | 
| `pg_normalized_batch`  | 1m33.995s                 | 11.694s                   | 
| `pg_denormalized`      | 14.574s                   | 2.725s                    | 
